...
is the definition of a constructor in Go&mdash;would
...
the `[net/http/pprof](/pkg/net/http/pprof/)`
...
One instance is in the `[encoding/json](/pkg/encoding/json/)`
package, which defines a `[Marshaler](/pkg/encoding/json/#Marshaler)`
...
`[json.RawMessage](/pkg/encoding/json/#RawMessage)`—needs
...
The function `[runtime.NumCPU](/pkg/runtime#NumCPU)`
